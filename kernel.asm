...
80100b7e:	e8 9d 5d 00 00       	call   80106920 <freevm>
  return -1;
...
80100b8d:	e8 0e 20 00 00       	call   80102ba0 <end_op>
    cprintf("exec: fail\n");
80100b92:	c7 04 24 21 6e 10 80 	movl   $0x80106e21,(%esp)
...
80100bba:	e8 91 5e 00 00       	call   80106a50 <clearpteu>
  if((sp=allocuvm(pgdir, STKBASE - PGSIZE, STKBASE))==0)
...
80100bd2:	e8 29 5c 00 00       	call   80106800 <allocuvm>
...
80100be4:	0f 84 5b 01 00 00    	je     80100d45 <exec+0x3a5>
...
80100c43:	e8 48 60 00 00       	call   80106c90 <copyout>
...
80100cb0:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cb6:	e8 d5 5f 00 00       	call   80106c90 <copyout>
...
80100d31:	e8 6a 58 00 00       	call   801065a0 <switchuvm>
  freevm(oldpgdir);
80100d36:	89 34 24             	mov    %esi,(%esp)
80100d39:	e8 e2 5b 00 00       	call   80106920 <freevm>
  return 0;
80100d3e:	31 c0                	xor    %eax,%eax
80100d40:	e9 cd fc ff ff       	jmp    80100a12 <exec+0x72>
  for(argc = 0; argv[argc]; argc++) {
80100d45:	31 f6                	xor    %esi,%esi
80100d47:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d4d:	e9 1e ff ff ff       	jmp    80100c70 <exec+0x2d0>
...
80100d66:	c7 44 24 04 2d 6e 10 	movl   $0x80106e2d,0x4(%esp)
80100d6d:	80 
...
80100e26:	c3                   	ret    
    panic("filedup");
80100e27:	c7 04 24 34 6e 10 80 	movl   $0x80106e34,(%esp)
...
80100ee7:	e9 b4 1c 00 00       	jmp    80102ba0 <end_op>
    panic("fileclose");
80100eec:	c7 04 24 3c 6e 10 80 	movl   $0x80106e3c,(%esp)
...
80100fd5:	eb d8                	jmp    80100faf <fileread+0x5f>
  panic("fileread");
80100fd7:	c7 04 24 46 6e 10 80 	movl   $0x80106e46,(%esp)
...
801010ec:	e9 1f 22 00 00       	jmp    80103310 <pipewrite>
        panic("short filewrite");
801010f1:	c7 04 24 4f 6e 10 80 	movl   $0x80106e4f,(%esp)
801010f8:	e8 63 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010fd:	c7 04 24 55 6e 10 80 	movl   $0x80106e55,(%esp)
...
801011b5:	c7 04 24 5f 6e 10 80 	movl   $0x80106e5f,(%esp)
...
801012dd:	c7 04 24 75 6e 10 80 	movl   $0x80106e75,(%esp)
...
80101395:	eb 93                	jmp    8010132a <bmap+0x3a>
  panic("bmap: out of range");
80101397:	c7 04 24 85 6e 10 80 	movl   $0x80106e85,(%esp)
...
80101479:	c7 04 24 98 6e 10 80 	movl   $0x80106e98,(%esp)
...
8010149c:	c7 44 24 04 ab 6e 10 	movl   $0x80106eab,0x4(%esp)
801014a3:	80 
...
801014b9:	c7 44 24 04 b2 6e 10 	movl   $0x80106eb2,0x4(%esp)
801014c0:	80 
...
801014e6:	c7 04 24 18 6f 10 80 	movl   $0x80106f18,(%esp)
...
80101601:	c7 04 24 b8 6e 10 80 	movl   $0x80106eb8,(%esp)
...
80101784:	0f 85 76 ff ff ff    	jne    80101700 <ilock+0x30>
      panic("ilock: no type");
8010178a:	c7 04 24 d0 6e 10 80 	movl   $0x80106ed0,(%esp)
80101791:	e8 ca eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101796:	c7 04 24 ca 6e 10 80 	movl   $0x80106eca,(%esp)
...
801017de:	e9 1d 28 00 00       	jmp    80104000 <releasesleep>
    panic("iunlock");
801017e3:	c7 04 24 df 6e 10 80 	movl   $0x80106edf,(%esp)
...
80101c81:	c3                   	ret    
      panic("dirlookup read");
80101c82:	c7 04 24 f9 6e 10 80 	movl   $0x80106ef9,(%esp)
80101c89:	e8 d2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c8e:	c7 04 24 e7 6e 10 80 	movl   $0x80106ee7,(%esp)
...
80101f03:	eb e9                	jmp    80101eee <dirlink+0xae>
      panic("dirlink read");
80101f05:	c7 04 24 08 6f 10 80 	movl   $0x80106f08,(%esp)
80101f0c:	e8 4f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101f11:	c7 04 24 06 75 10 80 	movl   $0x80107506,(%esp)
...
80101fff:	c7 04 24 74 6f 10 80 	movl   $0x80106f74,(%esp)
80102006:	e8 55 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
8010200b:	c7 04 24 6b 6f 10 80 	movl   $0x80106f6b,(%esp)
...
80102026:	c7 44 24 04 86 6f 10 	movl   $0x80106f86,0x4(%esp)
8010202d:	80 
...
801021f9:	eb bb                	jmp    801021b6 <iderw+0x76>
    panic("iderw: buf not locked");
801021fb:	c7 04 24 8a 6f 10 80 	movl   $0x80106f8a,(%esp)
80102202:	e8 59 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
80102207:	c7 04 24 b5 6f 10 80 	movl   $0x80106fb5,(%esp)
8010220e:	e8 4d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
80102213:	c7 04 24 a0 6f 10 80 	movl   $0x80106fa0,(%esp)
...
80102268:	c7 04 24 d4 6f 10 80 	movl   $0x80106fd4,(%esp)
...
8010239c:	eb bb                	jmp    80102359 <kfree+0x49>
    panic("kfree");
8010239e:	c7 04 24 06 70 10 80 	movl   $0x80107006,(%esp)
...
8010240b:	c7 44 24 04 0c 70 10 	movl   $0x8010700c,0x4(%esp)
80102412:	80 
...
80102554:	0f b6 81 40 71 10 80 	movzbl -0x7fef8ec0(%ecx),%eax
...
80102588:	0f b6 91 40 71 10 80 	movzbl -0x7fef8ec0(%ecx),%edx
  shift ^= togglecode[data];
8010258f:	0f b6 81 40 70 10 80 	movzbl -0x7fef8fc0(%ecx),%eax
  shift |= shiftcode[data];
...
8010259f:	8b 04 85 20 70 10 80 	mov    -0x7fef8fe0(,%eax,4),%eax
  shift ^= togglecode[data];
...
80102a9b:	c7 44 24 04 40 72 10 	movl   $0x80107240,0x4(%esp)
80102aa2:	80 
...
80102cc2:	c3                   	ret    
    panic("log.committing");
80102cc3:	c7 04 24 44 72 10 80 	movl   $0x80107244,(%esp)
...
80102d7d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d80:	c7 04 24 53 72 10 80 	movl   $0x80107253,(%esp)
80102d87:	e8 d4 d5 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d8c:	c7 04 24 69 72 10 80 	movl   $0x80107269,(%esp)
...
80102db7:	c7 04 24 84 72 10 80 	movl   $0x80107284,(%esp)
...
80102df3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102df6:	e8 85 37 00 00       	call   80106580 <switchkvm>
  seginit();
80102dfb:	e8 40 36 00 00       	call   80106440 <seginit>
  lapicinit();
...
80102e33:	e8 f8 3b 00 00       	call   80106a30 <kvmalloc>
...
80102e45:	e8 f6 35 00 00       	call   80106440 <seginit>
  picinit();       // disable pic
...
80102e5a:	e8 81 29 00 00       	call   801057e0 <uartinit>
80102e5f:	90                   	nop
  pinit();         // process table
80102e60:	e8 9b 07 00 00       	call   80103600 <pinit>
  shminit();       // shared memory
80102e65:	e8 b6 3e 00 00       	call   80106d20 <shminit>
  tvinit();        // trap vectors
...
80102f5f:	00 
80102f60:	c7 44 24 04 98 72 10 	movl   $0x80107298,0x4(%esp)
80102f67:	80 
...
8010301a:	00 
8010301b:	c7 44 24 04 9d 72 10 	movl   $0x8010729d,0x4(%esp)
80103022:	80 
...
801030ac:	ff 24 8d dc 72 10 80 	jmp    *-0x7fef8d24(,%ecx,4)
801030b3:	90                   	nop
...
80103137:	0f 85 c5 fe ff ff    	jne    80103002 <mpinit+0x52>
    panic("Expect to run on an SMP");
8010313d:	c7 04 24 a2 72 10 80 	movl   $0x801072a2,(%esp)
...
80103158:	eb e3                	jmp    8010313d <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010315a:	c7 04 24 bc 72 10 80 	movl   $0x801072bc,(%esp)
...
801031ff:	c7 44 24 04 f0 72 10 	movl   $0x801072f0,0x4(%esp)
80103206:	80 
...
80103606:	c7 44 24 04 f5 72 10 	movl   $0x801072f5,0x4(%esp)
8010360d:	80 
...
8010367a:	c7 04 24 fc 72 10 80 	movl   $0x801072fc,(%esp)
80103681:	e8 da cc ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103686:	c7 04 24 d8 73 10 80 	movl   $0x801073d8,(%esp)
...
80103725:	80 
80103726:	e8 85 2f 00 00       	call   801066b0 <inituvm>
  p->sz = PGSIZE;
...
801037a2:	00 
801037a3:	c7 44 24 04 25 73 10 	movl   $0x80107325,0x4(%esp)
801037aa:	80 
801037ab:	89 04 24             	mov    %eax,(%esp)
801037ae:	e8 cd 0c 00 00       	call   80104480 <safestrcpy>
  p->cwd = namei("/");
801037b3:	c7 04 24 2e 73 10 80 	movl   $0x8010732e,(%esp)
...
801037e7:	c7 04 24 0c 73 10 80 	movl   $0x8010730c,(%esp)
...
80103829:	e8 d2 2f 00 00       	call   80106800 <allocuvm>
...
80103837:	e8 64 2d 00 00       	call   801065a0 <switchuvm>
  return 0;
...
801039d2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039d5:	e8 c6 2b 00 00       	call   801065a0 <switchuvm>
...
801039eb:	e8 eb 0a 00 00       	call   801044db <swtch>
      switchkvm();
801039f0:	e8 8b 2b 00 00       	call   80106580 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103a8e:	c7 04 24 30 73 10 80 	movl   $0x80107330,(%esp)
80103a95:	e8 c6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a9a:	c7 04 24 5c 73 10 80 	movl   $0x8010735c,(%esp)
80103aa1:	e8 ba c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103aa6:	c7 04 24 4e 73 10 80 	movl   $0x8010734e,(%esp)
80103aad:	e8 ae c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103ab2:	c7 04 24 42 73 10 80 	movl   $0x80107342,(%esp)
...
80103bb6:	e8 65 fe ff ff       	call   80103a20 <sched>
  panic("zombie exit");
80103bbb:	c7 04 24 7d 73 10 80 	movl   $0x8010737d,(%esp)
80103bc2:	e8 99 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103bc7:	c7 04 24 70 73 10 80 	movl   $0x80107370,(%esp)
...
80103cae:	c7 04 24 8f 73 10 80 	movl   $0x8010738f,(%esp)
80103cb5:	e8 a6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103cba:	c7 04 24 89 73 10 80 	movl   $0x80107389,(%esp)
...
80103ea4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103ea8:	c7 04 24 1f 77 10 80 	movl   $0x8010771f,(%esp)
...
80103eca:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103ecd:	ba a0 73 10 80       	mov    $0x801073a0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103ed2:	77 11                	ja     80103ee5 <procdump+0x55>
80103ed4:	8b 14 85 00 74 10 80 	mov    -0x7fef8c00(,%eax,4),%edx
      state = "???";
80103edb:	b8 a0 73 10 80       	mov    $0x801073a0,%eax
...
80103ef0:	c7 04 24 a4 73 10 80 	movl   $0x801073a4,(%esp)
...
80103f39:	c7 04 24 e1 6d 10 80 	movl   $0x80106de1,(%esp)
...
80103f6a:	c7 44 24 04 18 74 10 	movl   $0x80107418,0x4(%esp)
80103f71:	80 
...
801041c7:	eb ac                	jmp    80104175 <acquire+0x15>
    panic("acquire");
801041c9:	c7 04 24 23 74 10 80 	movl   $0x80107423,(%esp)
...
80104229:	c3                   	ret    
    panic("popcli");
8010422a:	c7 04 24 42 74 10 80 	movl   $0x80107442,(%esp)
80104231:	e8 2a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104236:	c7 04 24 2b 74 10 80 	movl   $0x8010742b,(%esp)
...
8010425f:	75 0f                	jne    80104270 <release+0x20>
    panic("release");
80104261:	c7 04 24 49 74 10 80 	movl   $0x80107449,(%esp)
...
8010461d:	8b 14 85 80 74 10 80 	mov    -0x7fef8b80(,%eax,4),%edx
...
80104646:	c7 04 24 51 74 10 80 	movl   $0x80107451,(%esp)
...
801047d0:	c7 44 24 04 fc 74 10 	movl   $0x801074fc,0x4(%esp)
801047d7:	80 
...
801047eb:	c7 44 24 04 fb 74 10 	movl   $0x801074fb,0x4(%esp)
801047f2:	80 
...
80104801:	79 89                	jns    8010478c <create+0xdc>
      panic("create dots");
80104803:	c7 04 24 ef 74 10 80 	movl   $0x801074ef,(%esp)
8010480a:	e8 51 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010480f:	c7 04 24 fe 74 10 80 	movl   $0x801074fe,(%esp)
80104816:	e8 45 bb ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010481b:	c7 04 24 e0 74 10 80 	movl   $0x801074e0,(%esp)
...
80104bc1:	c7 44 24 04 fc 74 10 	movl   $0x801074fc,0x4(%esp)
80104bc8:	80 
...
80104bd9:	c7 44 24 04 fb 74 10 	movl   $0x801074fb,0x4(%esp)
80104be0:	80 
...
80104d2d:	c7 04 24 20 75 10 80 	movl   $0x80107520,(%esp)
80104d34:	e8 27 b6 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d39:	c7 04 24 32 75 10 80 	movl   $0x80107532,(%esp)
80104d40:	e8 1b b6 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d45:	c7 04 24 0e 75 10 80 	movl   $0x8010750e,(%esp)
...
801051f9:	e8 82 1b 00 00       	call   80106d80 <shm_open>
}
801051fe:	c9                   	leave  
801051ff:	c3                   	ret    
    return -1;
...
80105233:	e8 58 1b 00 00       	call   80106d90 <shm_close>
}
80105238:	c9                   	leave  
80105239:	c3                   	ret    
...
80105479:	c7 44 24 04 41 75 10 	movl   $0x80107541,0x4(%esp)
80105480:	80 
...
80105510:	ff 24 85 e8 75 10 80 	jmp    *-0x7fef8a18(,%eax,4)
80105517:	90                   	nop
    lapiceoi();
    break;
...
80105518:	e8 a3 e1 ff ff       	call   801036c0 <myproc>
...
8010553c:	e8 5f e1 ff ff       	call   801036a0 <cpuid>
...
8010554c:	e8 6f e1 ff ff       	call   801036c0 <myproc>
80105551:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105554:	e8 67 e1 ff ff       	call   801036c0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105583:	c7 04 24 a4 75 10 80 	movl   $0x801075a4,(%esp)
8010558a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010558e:	e8 bd b0 ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105593:	e8 28 e1 ff ff       	call   801036c0 <myproc>
...
801055a9:	e8 12 e1 ff ff       	call   801036c0 <myproc>
...
801055c0:	e8 fb e0 ff ff       	call   801036c0 <myproc>
...
801055c9:	74 4d                	je     80105618 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801055cb:	e8 f0 e0 ff ff       	call   801036c0 <myproc>
801055d0:	85 c0                	test   %eax,%eax
801055d2:	74 1d                	je     801055f1 <trap+0x101>
801055d4:	e8 e7 e0 ff ff       	call   801036c0 <myproc>
...
8010560b:	75 a8                	jne    801055b5 <trap+0xc5>
    exit();
8010560d:	e8 ae e4 ff ff       	call   80103ac0 <exit>
...
80105677:	e8 24 e0 ff ff       	call   801036a0 <cpuid>
8010567c:	c7 04 24 4c 75 10 80 	movl   $0x8010754c,(%esp)
...
8010568f:	e8 bc af ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105694:	e8 07 d1 ff ff       	call   801027a0 <lapiceoi>
    break;
80105699:	e9 02 ff ff ff       	jmp    801055a0 <trap+0xb0>
8010569e:	66 90                	xchg   %ax,%ax
    ideintr();
801056a0:	e8 fb c9 ff ff       	call   801020a0 <ideintr>
...
801056b5:	8b 70 24             	mov    0x24(%eax),%esi
801056b8:	85 f6                	test   %esi,%esi
801056ba:	75 2c                	jne    801056e8 <trap+0x1f8>
    myproc()->tf = tf;
801056bc:	e8 ff df ff ff       	call   801036c0 <myproc>
801056c1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801056c4:	e8 37 ef ff ff       	call   80104600 <syscall>
    if(myproc()->killed)
801056c9:	e8 f2 df ff ff       	call   801036c0 <myproc>
801056ce:	8b 48 24             	mov    0x24(%eax),%ecx
...
8010573a:	c7 04 24 70 75 10 80 	movl   $0x80107570,(%esp)
80105741:	89 44 24 04          	mov    %eax,0x4(%esp)
80105745:	e8 06 af ff ff       	call   80100650 <cprintf>
      panic("trap");
8010574a:	c7 04 24 46 75 10 80 	movl   $0x80107546,(%esp)
...
801057b7:	e8 04 d0 ff ff       	call   801027c0 <microdelay>
...
80105847:	00 
  for(p="xv6...\n"; *p; p++)
80105848:	bb 68 76 10 80       	mov    $0x80107668,%ebx
  ioapicenable(IRQ_COM1, 0);
8010584d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105854:	e8 77 ca ff ff       	call   801022d0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80106354:	e8 67 c1 ff ff       	call   801024c0 <kalloc>
...
80106372:	e8 29 df ff ff       	call   801042a0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801063e3:	e8 28 bf ff ff       	call   80102310 <kfree>
      *pte = 0;
...
8010642a:	c3                   	ret    
        panic("kfree");
8010642b:	c7 04 24 06 70 10 80 	movl   $0x80107006,(%esp)
...
80106443:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106446:	e8 55 d2 ff ff       	call   801036a0 <cpuid>
...
80106571:	c3                   	ret    
      panic("remap");
80106572:	c7 04 24 70 76 10 80 	movl   $0x80107670,(%esp)
...
801065c4:	0f 84 c3 00 00 00    	je     8010668d <switchuvm+0xed>
  pushcli();
801065ca:	e8 51 db ff ff       	call   80104120 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801065cf:	e8 4c d0 ff ff       	call   80103620 <mycpu>
801065d4:	89 c3                	mov    %eax,%ebx
801065d6:	e8 45 d0 ff ff       	call   80103620 <mycpu>
801065db:	89 c7                	mov    %eax,%edi
801065dd:	e8 3e d0 ff ff       	call   80103620 <mycpu>
801065e2:	83 c7 08             	add    $0x8,%edi
801065e5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801065e8:	e8 33 d0 ff ff       	call   80103620 <mycpu>
...
8010667b:	5d                   	pop    %ebp
  popcli();
8010667c:	e9 5f db ff ff       	jmp    801041e0 <popcli>
    panic("switchuvm: no process");
80106681:	c7 04 24 76 76 10 80 	movl   $0x80107676,(%esp)
80106688:	e8 d3 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010668d:	c7 04 24 a1 76 10 80 	movl   $0x801076a1,(%esp)
80106694:	e8 c7 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106699:	c7 04 24 8c 76 10 80 	movl   $0x8010768c,(%esp)
...
801066ca:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
801066cd:	e8 ee bd ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
801066e5:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801066e7:	e8 b4 db ff ff       	call   801042a0 <memset>
...
80106728:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106729:	e9 12 dc ff ff       	jmp    80104340 <memmove>
    panic("inituvm: more than a page");
8010672e:	c7 04 24 b5 76 10 80 	movl   $0x801076b5,(%esp)
...
801067bd:	e8 be b1 ff ff       	call   80101980 <readi>
...
801067e2:	c7 04 24 cf 76 10 80 	movl   $0x801076cf,(%esp)
801067e9:	e8 72 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
801067ee:	c7 04 24 70 77 10 80 	movl   $0x80107770,(%esp)
...
8010684b:	e8 50 da ff ff       	call   801042a0 <memset>
...
80106885:	76 29                	jbe    801068b0 <allocuvm+0xb0>
    mem = kalloc();
80106887:	e8 34 bc ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106892:	c7 04 24 ed 76 10 80 	movl   $0x801076ed,(%esp)
...
801068c0:	c7 04 24 05 77 10 80 	movl   $0x80107705,(%esp)
...
801068e1:	e8 2a ba ff ff       	call   80102310 <kfree>
      return 0;
...
8010696d:	e8 9e b9 ff ff       	call   80102310 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
...
80106982:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106983:	e9 88 b9 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106988:	c7 04 24 21 77 10 80 	movl   $0x80107721,(%esp)
...
801069a8:	e8 13 bb ff ff       	call   801024c0 <kalloc>
...
80106a6b:	c3                   	ret    
    panic("clearpteu");
80106a6c:	c7 04 24 32 77 10 80 	movl   $0x80107732,(%esp)
...
80106a86:	83 ec 2c             	sub    $0x2c,%esp
  struct proc *p = myproc();
80106a89:	e8 32 cc ff ff       	call   801036c0 <myproc>
80106a8e:	89 45 dc             	mov    %eax,-0x24(%ebp)
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80106a91:	e8 0a ff ff ff       	call   801069a0 <setupkvm>
80106a96:	85 c0                	test   %eax,%eax
80106a98:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106a9b:	0f 84 85 01 00 00    	je     80106c26 <copyuvm+0x1a6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106aa1:	8b 45 0c             	mov    0xc(%ebp),%eax
80106aa4:	85 c0                	test   %eax,%eax
80106aa6:	0f 84 bc 00 00 00    	je     80106b68 <copyuvm+0xe8>
80106aac:	31 db                	xor    %ebx,%ebx
80106aae:	eb 51                	jmp    80106b01 <copyuvm+0x81>
...
80106ab0:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106ab6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106abd:	00 
80106abe:	89 74 24 04          	mov    %esi,0x4(%esp)
80106ac2:	89 04 24             	mov    %eax,(%esp)
80106ac5:	e8 76 d8 ff ff       	call   80104340 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0){
80106aca:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106acd:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106ad4:	00 
80106ad5:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106ad9:	89 44 24 10          	mov    %eax,0x10(%esp)
80106add:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106ae3:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106ae7:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106aea:	89 04 24             	mov    %eax,(%esp)
80106aed:	e8 0e fa ff ff       	call   80106500 <mappages>
80106af2:	85 c0                	test   %eax,%eax
80106af4:	78 62                	js     80106b58 <copyuvm+0xd8>
  for(i = 0; i < sz; i += PGSIZE){
80106af6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106afc:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106aff:	76 67                	jbe    80106b68 <copyuvm+0xe8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106b01:	8b 45 08             	mov    0x8(%ebp),%eax
80106b04:	31 c9                	xor    %ecx,%ecx
80106b06:	89 da                	mov    %ebx,%edx
80106b08:	e8 03 f8 ff ff       	call   80106310 <walkpgdir>
80106b0d:	85 c0                	test   %eax,%eax
80106b0f:	0f 84 24 01 00 00    	je     80106c39 <copyuvm+0x1b9>
    if(!(*pte & PTE_P))
80106b15:	8b 38                	mov    (%eax),%edi
80106b17:	f7 c7 01 00 00 00    	test   $0x1,%edi
80106b1d:	0f 84 0a 01 00 00    	je     80106c2d <copyuvm+0x1ad>
    pa = PTE_ADDR(*pte);
80106b23:	89 fe                	mov    %edi,%esi
    flags = PTE_FLAGS(*pte);
80106b25:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80106b2b:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106b2e:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106b34:	e8 87 b9 ff ff       	call   801024c0 <kalloc>
80106b39:	85 c0                	test   %eax,%eax
80106b3b:	89 c7                	mov    %eax,%edi
80106b3d:	0f 85 6d ff ff ff    	jne    80106ab0 <copyuvm+0x30>
			goto bad;
		}
	}
	return d;
...
80106b49:	e8 d2 fd ff ff       	call   80106920 <freevm>
	return 0;
...
80106b57:	c3                   	ret    
			kfree(mem);
80106b58:	89 3c 24             	mov    %edi,(%esp)
80106b5b:	e8 b0 b7 ff ff       	call   80102310 <kfree>
			goto bad;
80106b60:	eb e1                	jmp    80106b43 <copyuvm+0xc3>
80106b62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	for(i=(STKBASE-p->np*PGSIZE+4);i<STKBASE;i+=PGSIZE){
80106b68:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106b6b:	8b 58 7c             	mov    0x7c(%eax),%ebx
80106b6e:	f7 db                	neg    %ebx
80106b70:	c1 e3 0c             	shl    $0xc,%ebx
80106b73:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80106b79:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
80106b7f:	76 5b                	jbe    80106bdc <copyuvm+0x15c>
80106b81:	e9 95 00 00 00       	jmp    80106c1b <copyuvm+0x19b>
...
80106b9d:	e8 9e d7 ff ff       	call   80104340 <memmove>
		if(mappages(d, (void*) i, PGSIZE, V2P(mem), flags) < 0){
80106ba2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ba5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106bac:	00 
80106bad:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106bb1:	89 44 24 10          	mov    %eax,0x10(%esp)
80106bb5:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106bbb:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106bbf:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106bc2:	89 04 24             	mov    %eax,(%esp)
80106bc5:	e8 36 f9 ff ff       	call   80106500 <mappages>
80106bca:	85 c0                	test   %eax,%eax
80106bcc:	78 8a                	js     80106b58 <copyuvm+0xd8>
	for(i=(STKBASE-p->np*PGSIZE+4);i<STKBASE;i+=PGSIZE){
80106bce:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106bd4:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
80106bda:	77 3f                	ja     80106c1b <copyuvm+0x19b>
		if((pte=walkpgdir(pgdir, (void *)i, 0))==0)
80106bdc:	8b 45 08             	mov    0x8(%ebp),%eax
80106bdf:	31 c9                	xor    %ecx,%ecx
80106be1:	89 da                	mov    %ebx,%edx
80106be3:	e8 28 f7 ff ff       	call   80106310 <walkpgdir>
80106be8:	85 c0                	test   %eax,%eax
80106bea:	74 4d                	je     80106c39 <copyuvm+0x1b9>
		if(!(*pte & PTE_P))
80106bec:	8b 38                	mov    (%eax),%edi
80106bee:	f7 c7 01 00 00 00    	test   $0x1,%edi
80106bf4:	74 37                	je     80106c2d <copyuvm+0x1ad>
		pa=PTE_ADDR(*pte);
80106bf6:	89 fe                	mov    %edi,%esi
		flags=PTE_FLAGS(*pte);
80106bf8:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80106bfe:	89 7d e4             	mov    %edi,-0x1c(%ebp)
		pa=PTE_ADDR(*pte);
80106c01:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
		if((mem=kalloc())==0)
80106c07:	e8 b4 b8 ff ff       	call   801024c0 <kalloc>
80106c0c:	85 c0                	test   %eax,%eax
80106c0e:	89 c7                	mov    %eax,%edi
80106c10:	0f 85 72 ff ff ff    	jne    80106b88 <copyuvm+0x108>
80106c16:	e9 28 ff ff ff       	jmp    80106b43 <copyuvm+0xc3>
...
80106c28:	e9 23 ff ff ff       	jmp    80106b50 <copyuvm+0xd0>
      panic("copyuvm: page not present");
80106c2d:	c7 04 24 56 77 10 80 	movl   $0x80107756,(%esp)
80106c34:	e8 27 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106c39:	c7 04 24 3c 77 10 80 	movl   $0x8010773c,(%esp)
...
80106c5e:	e8 ad f6 ff ff       	call   80106310 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106ccc:	e8 6f d6 ff ff       	call   80104340 <memmove>
    len -= n;
    buf += n;
...
80106d35:	e8 36 d3 ff ff       	call   80104070 <initlock>
  acquire(&(shm_table.lock));
80106d3a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d41:	e8 1a d4 ff ff       	call   80104160 <acquire>
...
80106d75:	e8 d6 d4 ff ff       	call   80104250 <release>
}
80106d7a:	c9                   	leave  
80106d7b:	c3                   	ret    
